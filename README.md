...
Подпроект 1, этап 1 (загрузка) готов: ядро в формате arm64 Image загружается
в QEMU, включает MMU, работает в верхней половине адресов, читает дерево
устройств и ловит исключения. Следующий этап: память, потоки и планировщик.
